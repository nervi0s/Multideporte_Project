...
namespace Futbol_Sala_Manager_App.Persistencia
{
    ...
    {
        private const string FileConfig = "Futbol_Sala_Manager_App.cfg";
        private const string FileBackup = "Futbol_Sala_Manager_App.bak";
        private const string FilePlantillas = "Futbol_Sala_Manager_App.tem";
        ...
        {
            DirectoryInfo di = new DirectoryInfo(Path.GetDirectoryName(Application.ExecutablePath) + @"\futbol_sala");
