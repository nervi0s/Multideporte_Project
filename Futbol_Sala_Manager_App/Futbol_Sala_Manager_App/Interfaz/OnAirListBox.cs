    ...
    public class OnAirListBox : System.Windows.Forms.ListBox
    {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (e.Index > -1)
            {
                ...
                bool hayMomento = false;
                int indexApostrofe = texto.IndexOf("'");
                if (indexApostrofe != -1)
                {
                    string posibleNumero = texto.Substring(indexApostrofe - 1, 1);
                    bool isNum = Int32.TryParse(posibleNumero, out _);
                    hayMomento = isNum;
                }
                ...
                if (hayMomento)
                {
                    int splitMomento = texto.IndexOf("'") + 1;
