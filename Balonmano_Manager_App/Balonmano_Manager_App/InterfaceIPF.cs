...
namespace Balonmano_Manager_App
{
    ...
    public class InterfaceIPF
    {
         ...
         */
        public void ConfigInicial(string badgesPath, Equipo local, Equipo visitante, bool multicast, string aggregate)
        {
        ...
        {
            //Envia("MapsIniciales(['" + local.FullName.Replace("'", "\\'") + "', '" + visitante.FullName.Replace("'", "\\'") + "', '" +
            ...
            Envia("EmptyGoalOUT(['" + local.TeamCode.Replace("'", "\\'") + "'])");
            Envia("EmptyGoalOUT(['" + visitante.TeamCode.Replace("'", "\\'") + "'])");
        }
