        ...
        public void CargaListaPartidos(List<Encuentro> encuentros)
        {
            ...
            if (encuentros != null)
            {
                foreach (Encuentro s in encuentros)
                {
                    ...
                    int id = s.Id;
                    b.Click += delegate { _controlador.CargaEncuentro(id, this._form); };
            ...
            else // Error en carga de encuentros
            {
                ...
                b.Height = 45;
                b.Font = new System.Drawing.Font("Segoe UI", 15.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
