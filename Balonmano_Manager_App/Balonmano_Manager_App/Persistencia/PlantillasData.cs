...
namespace Balonmano_Manager_App.Persistencia
{
    ...
    public class PlantillasData
    {
        ...
        private List<ICommand> _localizadores;
        public List<ICommand> Localizadores
        {
            get { return _localizadores; }
            set { _localizadores = value; }
        }
        ...
        private List<ICommand> _nextTransmission;
        public List<ICommand> NextTransmission
        {
            get { return _nextTransmission; }
            set { _nextTransmission = value; }
        }

        private List<ICommand> _schedule;
        public List<ICommand> Schedule
        {
        ...
        public PlantillasData()
        {
            ...
            Localizadores = new List<ICommand>();
            ...
            NextTransmission = new List<ICommand>();
            Schedule = new List<ICommand>();
        }
