...
namespace Balonmano_Manager_App.AccesoBD
{
    ...
    public class DummyData : IAccesoBD
    {
        ...
        private static Equipo getEquipoLocal()
        {
            ...
            jugadores[1].Posicion = Jugador.Extremo;
            ...
            jugadores[2].Posicion = Jugador.Extremo;
            ...
            jugadores[3].Posicion = Jugador.Extremo;
            ...
            jugadores[4].Posicion = Jugador.Extremo;
            ...
            jugadores[5].Posicion = Jugador.Lateral;
            ...
            jugadores[6].Posicion = Jugador.Lateral;
            ...
            jugadores[7].Posicion = Jugador.Lateral;
            ...
            jugadores[8].Posicion = Jugador.Central;
            ...
            jugadores[9].Posicion = Jugador.Central;
            ...
            jugadores[10].Posicion = Jugador.Pivote;
            ...
            banquillo[1].Posicion = Jugador.Extremo;
            ...
            banquillo[2].Posicion = Jugador.Extremo;
            ...
            banquillo[3].Posicion = Jugador.Extremo;
            ...
            banquillo[4].Posicion = Jugador.Lateral;
            ...
            banquillo[5].Posicion = Jugador.Lateral;
            ...
            banquillo[6].Posicion = Jugador.Lateral;
        ...
        private static Equipo getEquipoVisitante()
        {
            ...
            jugadores[4].Posicion = Jugador.Lateral;
            jugadores[4].PosX = "0.9";
            jugadores[4].PosY = "0.8";
            jugadores[4].Equipo = e;
        ...
        private static List<ICommand> getArbitros()
        {
            ...
            Arbitro p1 = new Arbitro();
            p1.FullName = "Germán Navarro";
            p1.ShortName = "Germán";
            p1.Nacionalidad = "ESP";
            p1.Cargo = Arbitro.Arbitro1;

            Arbitro p2 = new Arbitro();
            p2.FullName = "Carolina Gomez";
            p2.ShortName = "Carolina";
            p2.Cargo = Arbitro.Arbitro2;

            //Arbitro l2 = new Arbitro();
            //l2.FullName = "Jesus almansa";
            //l2.ShortName = "Jesus";
            //l2.Cargo = Arbitro.Linier2;

            //Arbitro a1 = new Arbitro();
            //a1.FullName = "Ignacio Alonso";
            //a1.ShortName = "Ignacio";
            //a1.Cargo = Arbitro.Auxiliar1;

            //Arbitro a2 = new Arbitro();
            //a2.FullName = "Miguel Angel";
            //a2.ShortName = "Miguel";
            //a2.Cargo = Arbitro.Auxiliar2;

            //Arbitro c = new Arbitro();
            //c.FullName = "Juan Luis";
            //c.ShortName = "Juan Luis";
            //c.Cargo = Arbitro.CuartoArbitro;

            arbitros.Add(new RefereesCommand(p1, p2));
            arbitros.Add(new IdentificationCommand(p1));
            arbitros.Add(new IdentificationCommand(p2));
            //arbitros.Add(new IdentificationCommand(l2));
            //arbitros.Add(new IdentificationCommand(c));
            //arbitros.Add(new IdentificationCommand(a1));
            //arbitros.Add(new IdentificationCommand(a2));
