...
namespace Futbol_Manager_App.Persistencia
{
    ...
    {
        private const string FilaConfig = "Futbol_Manager_App.cfg";
        private const string FileBackup = "Futbol_Manager_App.bak";
        private const string FilePlantillas = "Futbol_Manager_App.tem";
        ...
        {
            return cargaXml<ConfigData>(addRuta(FilaConfig));
        }
        ...
        {
            creaXml(config, addRuta(FilaConfig));
        }
        ...
        {
            DirectoryInfo di = new DirectoryInfo(Path.GetDirectoryName(Application.ExecutablePath) + @"\futbol");
