...
namespace Futbol_Manager_App.AccesoBD
{
    ...
    public class DummyData : IAccesoBD
    {
        ...
        private static Equipo getEquipoLocal()
        {
            ...
            e.Color2 = System.Drawing.Color.Red;
            ...
            jugadores[1].Posicion = Jugador.Defensa;
            ...
            jugadores[2].Posicion = Jugador.Defensa;
            ...
            jugadores[3].Posicion = Jugador.Defensa;
            ...
            jugadores[4].Posicion = Jugador.Defensa;
            ...
            jugadores[5].Posicion = Jugador.Centrocampista;
            ...
            jugadores[6].Posicion = Jugador.Centrocampista;
            ...
            jugadores[7].Posicion = Jugador.Centrocampista;
            ...
            jugadores[8].Posicion = Jugador.Centrocampista;
            ...
            jugadores[9].Posicion = Jugador.Delantero;
            ...
            jugadores[10].Posicion = Jugador.Delantero;
            ...
            banquillo[1].Posicion = Jugador.Defensa;
            ...
            banquillo[2].Posicion = Jugador.Defensa;
            ...
            banquillo[3].Posicion = Jugador.Defensa;
            ...
            banquillo[4].Posicion = Jugador.Centrocampista;
            ...
            banquillo[5].Posicion = Jugador.Centrocampista;
            ...
            banquillo[6].Posicion = Jugador.Centrocampista;
        ...
        private static Equipo getEquipoVisitante()
        {
            ...
            jugadores[4].Posicion = Jugador.Centrocampista;
            jugadores[4].PosX = "0.9";
            jugadores[4].PosY = "0.8";
            jugadores[4].Equipo = e;
        ...
        private static List<ICommand> getArbitros()
        {
            ...
            arbitro3.FullName = "Jesus almansa";
            arbitro3.ShortName = "Jesus";
            arbitro3.Cargo = Arbitro.arbitro3;

            Arbitro arbitro4 = new Arbitro();
            arbitro4.FullName = "Ignacio Alonso";
            arbitro4.ShortName = "Ignacio";
            arbitro4.Cargo = Arbitro.arbitro4;

            //Arbitro a2 = new Arbitro();
            //a2.FullName = "Miguel Angel";
            //a2.ShortName = "Miguel";
            //a2.Cargo = Arbitro.arbitro4;

            //Arbitro c = new Arbitro();
            //c.FullName = "Juan Luis";
            //c.ShortName = "Juan Luis";
            //c.Cargo = Arbitro.arbitro4;

            arbitros.Add(new RefereesCommand(arbitro1, arbitro2, arbitro3, arbitro4));
            arbitros.Add(new IdentificationCommand(arbitro1));
            arbitros.Add(new IdentificationCommand(arbitro2));
            arbitros.Add(new IdentificationCommand(arbitro3));
            arbitros.Add(new IdentificationCommand(arbitro4));
